    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-modal p-10">
        ...
        <div className="flex flex-col items-center gap-4 mb-8 w-full text-center">
          ...
          />
          {/* Silq Legal Manager — product name */}
          <p className="text-lg font-bold text-gray-900 tracking-tight leading-none w-full text-center">Silq Legal Manager</p>
        </div>
